...
/* package diffie-hellman-0.1.0.0 */
#ifndef VERSION_diffie_hellman
#define VERSION_diffie_hellman "0.1.0.0"
#endif /* VERSION_diffie_hellman */
#ifndef MIN_VERSION_diffie_hellman
#define MIN_VERSION_diffie_hellman(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_diffie_hellman */
...
#define CURRENT_COMPONENT_ID "diffie-hellman-0.1.0.0-inplace-diffie-hellman"
