...
/* package CBC-crack-0.1.0.0 */
#ifndef VERSION_CBC_crack
#define VERSION_CBC_crack "0.1.0.0"
#endif /* VERSION_CBC_crack */
#ifndef MIN_VERSION_CBC_crack
#define MIN_VERSION_CBC_crack(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CBC_crack */
...
#define CURRENT_COMPONENT_ID "CBC-crack-0.1.0.0-inplace-CBC-crack"
